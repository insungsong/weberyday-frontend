...
const SignUpAgreeCheck = styled.fieldset``;
          ...
          <CertificationForm>
            ...
            <SignUpOption>
              <LoginGender>
                ...
                <LoginGenderOption>
                  <LabelOption>
                    <CheckInput name="gender" value="femail" {...gender} />
                    <i style={{ width: "100%" }}>여성</i>
                  </LabelOption>
                  <LabelOption>
                    <CheckInput name="gender" value="mail" {...gender} />
                    <i>남성</i>
                  </LabelOption>
                </LoginGenderOption>
              </LoginGender>
